...
def train(racetrack, episodes, alpha, epsilon, steps):
    ...
    for _ in range(episodes):
        ...
        episode = [(state, None, execute_policy(behavior_policies[state.index]), None, None)]
        t = 0
        while True:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="N-step Q(sigma) (Section 7.6, Excercise 5.12).")
