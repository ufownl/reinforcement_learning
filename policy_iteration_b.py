...
class CarRental:
    def __init__(self, req_e, ret_e, rental, mv_cost, max_cars, max_mv_cars, free_mv_cars, free_lots, ex_cost):
        ...
        self.__states = [State((i, j), req_e, ret_e, rental, mv_cost, max_cars, max_mv_cars, free_mv_cars, free_lots, ex_cost) for i in range(max_cars + 1) for j in range(max_cars + 1)]
